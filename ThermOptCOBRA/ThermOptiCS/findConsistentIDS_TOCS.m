function [reacInd,x] = findConsistentIDS_TOCS(model,core,Nsnp,tic_idx,tol,runtime)
% Identifies the thermodynamically consistent IDs for the given input model
%
% USAGE: 
%   [reacInd,x] = findConsistentIDS_TOCS(model,core,Nsnp,tic_idx,tol,runtime)
%
% INPUTS:
...
%     runtime:   Maximum runtime for the MILP problem (Default: 120s)
%
% OUTPUTS:
